...
extension ISO3166.Continent {
    static func fromCountry(country: ISO3166.Country) -> ISO3166.Continent? {
        var continentCountryTuple: (ISO3166.Continent, ISO3166.Country)? = nil
        for tuple in countriesAndContinents where tuple.1 == country {
            continentCountryTuple = tuple
        }
        
        if let (continent, _) = continentCountryTuple {
            return continent
        }
        return nil
    }
...
extension ISO3166.Continent: CustomStringConvertible {
    public var description: String {
        return NSLocalizedString(localizationKey, tableName: nil, bundle: NSBundle.mainBundle(), value: localizationKey, comment: "")
    }
...
extension ISO3166.Country: LocalizedStringConvertible {
    public var localizedDescription: String {
        ...
        return loc.displayNameForKey(NSLocaleCountryCode, value: threeLetterName) ?? NSLocalizedString("country.Unknown", tableName: nil, bundle: NSBundle.mainBundle(), value: "country.Unknown", comment: "")
    }
}
